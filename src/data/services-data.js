...
import Scaffolding from "../components/anime/Scaffolding.json";
import Tool from "../components/anime/Worker.json";
const services_data = [
  {
    id: 1,
    duration: ".5s",
    ...
    title: "We offer",
    text_1:
      "Full supply and fix packages encompassing crane erection to crane dismantling and basic labour only.",
    text_2: "",
    home: true,
    service_p_2: true,
  },
  {
    ...
    text_1:
      "Bulk dig, groundworks, external works, reinforced concrete structures, concrete flooring, temporary works, tower crane hire and waterproofing.",
    text_2: "",
    home: true,
    service_p_2: true,
  },
