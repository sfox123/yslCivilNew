...
import ab1 from '../../../public/assets/img/breadcrum/Tower Crane.json';
import ab2 from '../../../public/assets/img/breadcrum/Excavator.json';
import ab3 from '../../../public/assets/anime/Helmet.json'
...
const contents = {
  ...
  client3_title: '',
  decs3: 'YSL Civils offers extensive experience in civil engineering and utilities projects. From infrastructure development to utility installations, we deliver comprehensive solutions tailored to meet your specific needs. Our team ensures quality and efficiency in every project, from planning to execution',
  about3_img:'',
}
const {client3_icon,client3_name,client3_title,decs3,client_icon,client_name,client_title,desc,right_text_1,right_text_2,title,video_id,client2_icon,client2_name,client2_title,desc2} = contents;
...
const AboutArea = () => {
  ...
  return (
    <>
      <div className="ac-about-content-area pt-130" style={{background:"white"}}>
          ...
          <div className="row ac-testimonial-space">
            ...
            <div className="col-xl-6 col-lg-6 wow tpfadeRight" data-wow-duration=".5s" data-wow-delay=".7s">
              <div className="ac-testimonial-right">
                ...
                <LottieAnimation animationData={ab1} height={animationSize} width={animationSize}/>
              </div>
            </div>
          </div>
          {/* client_2 */}
          <div className="row ac-testimonial-space">
            ...
            <div className="col-xl-6 col-lg-6 wow tpfadeRight" data-wow-duration=".5s" data-wow-delay=".7s">
              <div className="ac-testimonial-right">
                ...
                <LottieAnimation animationData={ab2} height={animationSize} width={animationSize}/>
              </div>
            </div>
          </div>
          {/*client_3*/}
          <div className="row ac-testimonial-space">
            <div className="col-xl-6 col-lg-6 wow tpfadeLeft" data-wow-duration=".3s" data-wow-delay=".5s">
              <div className="ac-testimonial-info">
                <div className="actestimonial">
                  <div className="actestimonial__icon">
                    <img width={'150'} height={'100'} src={client3_icon} alt="" />
                  </div>
                  <div className="actestimonial__position">
                    <h4 className="ac-client-name"><a href="#">{client3_name}</a></h4>
                    <span>{client3_title}</span>
                  </div>
                  <div className="actestimonial__paragraph">
                    <p> <span><i className="fas fa-quote-right"></i></span>{decs3}</p>
                  </div>
                </div>
              </div>
            </div>
            <div className="col-xl-6 col-lg-6 wow tpfadeRight" data-wow-duration=".5s" data-wow-delay=".7s">
              <div className="ac-testimonial-right">
                {/* <img src={about2_img} alt="" /> */}
                <LottieAnimation animationData={ab3} height={animationSize} width={animationSize}/>
              </div>
            </div>
          </div>
        </div>
